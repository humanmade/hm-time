...
function hm_time_user_profile_fields (){
	...
	hm_time_timezone_settings ( $user_id, $table_row, $input_text );
	hm_time_location_settings ( $user_id, $table_row, $input_text );
	hm_time_workhours_settings ( $user_id, $table_row, $input_text );
}
